                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input data-id="{{$dest->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Hiện" data-off="Ẩn" {{ $dest->status ? 'checked' : '' }}>
                                </td>
                                <td>
...
<script type="text/javascript">
    $('.toggle-class').change(function() {
        ...
        $.ajax({
            ...
            data: {'status': status, 'destination_id': destination_id},
